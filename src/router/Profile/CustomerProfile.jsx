          ...
          {isEditing ? (
            ...
            >
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder={
                  validationErrors.PhoneNumber || "Nhập số điện thoại"
                }
                className={theme === "dark" ? styles.darkInput : ""}
              />
            ...
            <div className={styles.profileInfo}>
              <p>
                ...
                <span className={styles.infoText}>{customer.FirstName}</span>
              </p>
              <p>
                <strong>{t("LastName")}</strong>{" "}
                <span className={styles.infoText}>{customer.LastName}</span>
              </p>
              <p>
                <strong>{t("DOB")}</strong>{" "}
                <span className={styles.infoText}>
              ...
              <p>
                ...
                <span className={styles.infoText}>
                  {customer.Gender === "1" ? t("Male") : t("Female")}
                </span>
              </p>
              <p>
                <strong>Email:</strong>{" "}
